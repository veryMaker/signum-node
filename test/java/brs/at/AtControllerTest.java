...
public class AtControllerTest {
    ...
    public void testRunSteps() {
        ...
        assertEquals("010000000000000097c1d1e5b25c1d109f2ba522d1dda248020000000000000014ea12712c274caebc49ccd7fff0b0b703000000000000009f1af5443c8d1e7b492f848e91fccb1f", Convert.INSTANCE.toHexString(atBlock.getBytesForBlock()));
    }
    ...
    public void testValidateAts() throws AtException {
        ...
        AtTestHelper.addTipThanksAT();
        assertEquals(3, AT.getOrderedATs().size());
        AtBlock atBlock = AtController.validateATs(Convert.INSTANCE.parseHexString("010000000000000097c1d1e5b25c1d109f2ba522d1dda248020000000000000014ea12712c274caebc49ccd7fff0b0b703000000000000009f1af5443c8d1e7b492f848e91fccb1f"), Integer.MAX_VALUE);
        assertNotNull(atBlock);
