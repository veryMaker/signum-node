...
public class AtTestHelper {
    ...
    public static byte[] HELLO_WORLD_CREATION_BYTES = getCreationBytes(Convert.parseHexString(""));

    // Echo example compiled with BlockTalk v0.0.0
    public static byte[] ECHO_CREATION_BYTES = getCreationBytes(Convert.parseHexString(""));

    // Tip Thanks example compiled with BlockTalk v0.0.0
    public static byte[] TIP_THANKS_CREATION_BYTES = getCreationBytes(Convert.parseHexString(""));
    ...
    public static void setupMocks() {
        ...
        doAnswer(invoke -> {
            if (onAtAdded != null) {
                onAtAdded.accept(invoke.getArgument(0));
            }
            return null;
    ...
    public static void setOnAtAdded(Consumer<AT> onAtAdded) {
        AtTestHelper.onAtAdded = onAtAdded;
    }

    public static short currentAtVersion() {
        return 2;
    }
    ...
    public static byte[] getCreationBytes(byte[] code) {
        short cpages = 1;
        short dpages = 1;
        short cspages = 1;
        short uspages = 1;
