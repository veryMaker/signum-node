...
public class AtTestHelper {
    ...
    static byte[] HELLO_WORLD_CREATION_BYTES = getCreationBytes(1, Convert.INSTANCE.parseHexString(""));

    // Echo example compiled with BlockTalk v0.0.0
    static byte[] ECHO_CREATION_BYTES = getCreationBytes(1, Convert.INSTANCE.parseHexString(""));

    // Tip Thanks example compiled with BlockTalk v0.0.0
    static byte[] TIP_THANKS_CREATION_BYTES = getCreationBytes(2, Convert.INSTANCE.parseHexString(""));
