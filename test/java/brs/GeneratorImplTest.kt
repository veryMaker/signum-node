...
class GeneratorImplTest {
    ...
    fun setUpGeneratorTest() {
        ...
        generator = GeneratorImpl(blockchain, timeService, fluxCapacitor)
    }
    ...
    fun testGeneratorCalculateHit() {
        assertEquals(BigInteger("14592422770739690569"), generator!!.calculateHit(TestConstants.TEST_ACCOUNT_NUMERIC_ID_PARSED, 0, exampleGenSig!!, 0, exampleHeight))
        ...
        assertEquals(BigInteger("16142911724569013009"), generator!!.calculateHit(TestConstants.TEST_ACCOUNT_NUMERIC_ID_PARSED, 0, exampleGenSig, Convert.parseHexString("6ec823b5fd86c4aee9f7c3453cacaf4a43296f48ede77e70060ca8225c2855d06ec823b5fd86c4aee9f7c3453cacaf4a43296f48ede77e70060ca8225c2855d0")!!))
    }
    ...
    companion object {
        ...
        private val exampleGenSig = Convert.parseHexString("6ec823b5fd86c4aee9f7c3453cacaf4a43296f48ede77e70060ca8225c2855d0")
