...
class GetAccountIdTest {
    ...
    fun processRequest() {
        ...
        assertEquals(TEST_ACCOUNT_NUMERIC_ID, result.getMemberAsString(ACCOUNT_RESPONSE))
        assertEquals(TEST_PUBLIC_KEY, result.getMemberAsString(PUBLIC_KEY_RESPONSE))
    }
