...
class CryptoTest {
    ...
    @Test
    fun testCryptoSign() {
        assertEquals("f6c3cace87e022565c1d547c4a13d216d765cb4aec098ed36ef758a33b11b3008573b8d81155939dc5677f4b222a3d3943c6e2f139cba3f82f5137d61b9a79fd", Crypto.sign(stringToBytes(""), TestConstants.TEST_SECRET_PHRASE)).toHexString()
        assertEquals("aa140db8d96a058b6d9488aa4d3771b0da3ad8d2bcfba64d8b3b117c1a73910efec6917aa986027784c46acfe645b400edfd04a77ad50af77e10d169b470d64b", Crypto.sign(stringToBytes("Testing"), TestConstants.TEST_SECRET_PHRASE)).toHexString()
        assertEquals("e4b7bcd76ebccbf6bf3d4ad1c72c6e0b3e902f041a38e37f8aac09ea5a43310d78a90061eb9c12f6d32174ce19bc4105223df38035f2cfc0ebb069591e1e1a01", Crypto.sign(stringToBytes("Burstcoin!"), TestConstants.TEST_SECRET_PHRASE)).toHexString()
        assertEquals("46ab525630fd4f2266d78309a04153dd7d69c8d3c77765956eff1b86cc4e5a0d8d0d8df1cfe8300617551361b99f54b5db7afbd8ffa0a21ddcdac2cfdec57b71", Crypto.sign(stringToBytes("Burst Apps Team"), TestConstants.TEST_SECRET_PHRASE)).toHexString()
    }

    @Test
    fun testCryptoVerify() {
        val publicKey = Crypto.getPublicKey(TestConstants.TEST_SECRET_PHRASE)
        assertTrue(Crypto.verify(Convert."f6c3cace87e022565c1d547c4a13d216d765cb4aec098ed36ef758a33b11b3008573b8d81155939dc5677f4b222a3d3943c6e2f139cba3f82f5137d61b9a79fd"), stringToBytes(""), publicKey, true).parseHexString()
        assertTrue(Crypto.verify(Convert."aa140db8d96a058b6d9488aa4d3771b0da3ad8d2bcfba64d8b3b117c1a73910efec6917aa986027784c46acfe645b400edfd04a77ad50af77e10d169b470d64b"), stringToBytes("Testing"), publicKey, true).parseHexString()
        assertTrue(Crypto.verify(Convert."e4b7bcd76ebccbf6bf3d4ad1c72c6e0b3e902f041a38e37f8aac09ea5a43310d78a90061eb9c12f6d32174ce19bc4105223df38035f2cfc0ebb069591e1e1a01"), stringToBytes("Burstcoin!"), publicKey, true).parseHexString()
        assertTrue(Crypto.verify(Convert."46ab525630fd4f2266d78309a04153dd7d69c8d3c77765956eff1b86cc4e5a0d8d0d8df1cfe8300617551361b99f54b5db7afbd8ffa0a21ddcdac2cfdec57b71"), stringToBytes("Burst Apps Team"), publicKey, true).parseHexString()
    }
