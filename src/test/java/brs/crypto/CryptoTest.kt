...
class CryptoTest {
    ...
    fun testCryptoVerify() {
        ...
        assertTrue(Crypto.verify("f6c3cace87e022565c1d547c4a13d216d765cb4aec098ed36ef758a33b11b3008573b8d81155939dc5677f4b222a3d3943c6e2f139cba3f82f5137d61b9a79fd".parseHexString(), stringToBytes(""), publicKey, true))
        assertTrue(Crypto.verify("aa140db8d96a058b6d9488aa4d3771b0da3ad8d2bcfba64d8b3b117c1a73910efec6917aa986027784c46acfe645b400edfd04a77ad50af77e10d169b470d64b".parseHexString(), stringToBytes("Testing"), publicKey, true))
        assertTrue(Crypto.verify("e4b7bcd76ebccbf6bf3d4ad1c72c6e0b3e902f041a38e37f8aac09ea5a43310d78a90061eb9c12f6d32174ce19bc4105223df38035f2cfc0ebb069591e1e1a01".parseHexString(), stringToBytes("Burstcoin!"), publicKey, true))
