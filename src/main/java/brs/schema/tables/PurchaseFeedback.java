...
public class PurchaseFeedback extends TableImpl<PurchaseFeedbackRecord> {
    ...
    private static final long serialVersionUID = 194589595;
     ...
     */
    public final TableField<PurchaseFeedbackRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.purchase_feedback.id</code>.
     */
    public final TableField<PurchaseFeedbackRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.feedback_data</code>.
     */
    public final TableField<PurchaseFeedbackRecord, byte[]> FEEDBACK_DATA = createField(DSL.name("feedback_data"), org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.feedback_nonce</code>.
     */
    public final TableField<PurchaseFeedbackRecord, byte[]> FEEDBACK_NONCE = createField(DSL.name("feedback_nonce"), org.jooq.impl.SQLDataType.VARBINARY(32).nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.height</code>.
     */
    public final TableField<PurchaseFeedbackRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.purchase_feedback.latest</code>.
     */
    public final TableField<PurchaseFeedbackRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
