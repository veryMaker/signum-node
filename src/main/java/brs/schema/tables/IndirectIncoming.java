...
public class IndirectIncoming extends TableImpl<IndirectIncomingRecord> {
    ...
    private static final long serialVersionUID = -1085938530;
     ...
     */
    public final TableField<IndirectIncomingRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.indirect_incoming.account_id</code>.
     */
    public final TableField<IndirectIncomingRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.indirect_incoming.transaction_id</code>.
     */
    public final TableField<IndirectIncomingRecord, Long> TRANSACTION_ID = createField(DSL.name("transaction_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.indirect_incoming.height</code>.
     */
    public final TableField<IndirectIncomingRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
