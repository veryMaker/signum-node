...
public class EscrowDecision extends TableImpl<EscrowDecisionRecord> {
    ...
    private static final long serialVersionUID = -1690833813;
     ...
     */
    public final TableField<EscrowDecisionRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.escrow_decision.escrow_id</code>.
     */
    public final TableField<EscrowDecisionRecord, Long> ESCROW_ID = createField(DSL.name("escrow_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.escrow_decision.account_id</code>.
     */
    public final TableField<EscrowDecisionRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.escrow_decision.decision</code>.
     */
    public final TableField<EscrowDecisionRecord, Integer> DECISION = createField(DSL.name("decision"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.escrow_decision.height</code>.
     */
    public final TableField<EscrowDecisionRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.escrow_decision.latest</code>.
     */
    public final TableField<EscrowDecisionRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
