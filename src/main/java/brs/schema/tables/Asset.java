...
public class Asset extends TableImpl<AssetRecord> {
    ...
    private static final long serialVersionUID = -1980200861;
     ...
     */
    public final TableField<AssetRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.asset.id</code>.
     */
    public final TableField<AssetRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset.account_id</code>.
     */
    public final TableField<AssetRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset.name</code>.
     */
    public final TableField<AssetRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>DB.asset.description</code>.
     */
    public final TableField<AssetRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.CLOB.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.CLOB)), this, "");

    /**
     * The column <code>DB.asset.quantity</code>.
     */
    public final TableField<AssetRecord, Long> QUANTITY = createField(DSL.name("quantity"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset.decimals</code>.
     */
    public final TableField<AssetRecord, Byte> DECIMALS = createField(DSL.name("decimals"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>DB.asset.height</code>.
     */
    public final TableField<AssetRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
