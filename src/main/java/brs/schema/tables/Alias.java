...
public class Alias extends TableImpl<AliasRecord> {
    ...
    private static final long serialVersionUID = -560142972;
     ...
     */
    public final TableField<AliasRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.alias.id</code>.
     */
    public final TableField<AliasRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.alias.account_id</code>.
     */
    public final TableField<AliasRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.alias.alias_name</code>.
     */
    public final TableField<AliasRecord, String> ALIAS_NAME = createField(DSL.name("alias_name"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>DB.alias.alias_name_lower</code>.
     */
    public final TableField<AliasRecord, String> ALIAS_NAME_LOWER = createField(DSL.name("alias_name_lower"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>DB.alias.alias_uri</code>.
     */
    public final TableField<AliasRecord, String> ALIAS_URI = createField(DSL.name("alias_uri"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>DB.alias.timestamp</code>.
     */
    public final TableField<AliasRecord, Integer> TIMESTAMP = createField(DSL.name("timestamp"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.alias.height</code>.
     */
    public final TableField<AliasRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.alias.latest</code>.
     */
    public final TableField<AliasRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
