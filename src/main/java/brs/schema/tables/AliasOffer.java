...
public class AliasOffer extends TableImpl<AliasOfferRecord> {
    ...
    private static final long serialVersionUID = 1142883418;
     ...
     */
    public final TableField<AliasOfferRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.alias_offer.id</code>.
     */
    public final TableField<AliasOfferRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.alias_offer.price</code>.
     */
    public final TableField<AliasOfferRecord, Long> PRICE = createField(DSL.name("price"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.alias_offer.buyer_id</code>.
     */
    public final TableField<AliasOfferRecord, Long> BUYER_ID = createField(DSL.name("buyer_id"), org.jooq.impl.SQLDataType.BIGINT.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>DB.alias_offer.height</code>.
     */
    public final TableField<AliasOfferRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.alias_offer.latest</code>.
     */
    public final TableField<AliasOfferRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
