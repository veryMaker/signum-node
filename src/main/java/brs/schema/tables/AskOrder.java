...
public class AskOrder extends TableImpl<AskOrderRecord> {
    ...
    private static final long serialVersionUID = 190186446;
     ...
     */
    public final TableField<AskOrderRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.ask_order.id</code>.
     */
    public final TableField<AskOrderRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.account_id</code>.
     */
    public final TableField<AskOrderRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.asset_id</code>.
     */
    public final TableField<AskOrderRecord, Long> ASSET_ID = createField(DSL.name("asset_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.price</code>.
     */
    public final TableField<AskOrderRecord, Long> PRICE = createField(DSL.name("price"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.quantity</code>.
     */
    public final TableField<AskOrderRecord, Long> QUANTITY = createField(DSL.name("quantity"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.creation_height</code>.
     */
    public final TableField<AskOrderRecord, Integer> CREATION_HEIGHT = createField(DSL.name("creation_height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.height</code>.
     */
    public final TableField<AskOrderRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.ask_order.latest</code>.
     */
    public final TableField<AskOrderRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
