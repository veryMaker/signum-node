...
public class RewardRecipAssign extends TableImpl<RewardRecipAssignRecord> {
    ...
    private static final long serialVersionUID = -957122469;
     ...
     */
    public final TableField<RewardRecipAssignRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.reward_recip_assign.account_id</code>.
     */
    public final TableField<RewardRecipAssignRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.prev_recip_id</code>.
     */
    public final TableField<RewardRecipAssignRecord, Long> PREV_RECIP_ID = createField(DSL.name("prev_recip_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.recip_id</code>.
     */
    public final TableField<RewardRecipAssignRecord, Long> RECIP_ID = createField(DSL.name("recip_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.from_height</code>.
     */
    public final TableField<RewardRecipAssignRecord, Integer> FROM_HEIGHT = createField(DSL.name("from_height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.height</code>.
     */
    public final TableField<RewardRecipAssignRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.reward_recip_assign.latest</code>.
     */
    public final TableField<RewardRecipAssignRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
