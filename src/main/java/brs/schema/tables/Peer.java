...
public class Peer extends TableImpl<PeerRecord> {
    ...
    private static final long serialVersionUID = 2046115552;
     ...
     */
    public final TableField<PeerRecord, String> ADDRESS = createField(DSL.name("address"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");
