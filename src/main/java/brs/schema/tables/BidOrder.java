...
public class BidOrder extends TableImpl<BidOrderRecord> {
    ...
    private static final long serialVersionUID = -1013696006;
     ...
     */
    public final TableField<BidOrderRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.bid_order.id</code>.
     */
    public final TableField<BidOrderRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.account_id</code>.
     */
    public final TableField<BidOrderRecord, Long> ACCOUNT_ID = createField(DSL.name("account_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.asset_id</code>.
     */
    public final TableField<BidOrderRecord, Long> ASSET_ID = createField(DSL.name("asset_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.price</code>.
     */
    public final TableField<BidOrderRecord, Long> PRICE = createField(DSL.name("price"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.quantity</code>.
     */
    public final TableField<BidOrderRecord, Long> QUANTITY = createField(DSL.name("quantity"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.creation_height</code>.
     */
    public final TableField<BidOrderRecord, Integer> CREATION_HEIGHT = createField(DSL.name("creation_height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.height</code>.
     */
    public final TableField<BidOrderRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.bid_order.latest</code>.
     */
    public final TableField<BidOrderRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
