...
public class AtState extends TableImpl<AtStateRecord> {
    ...
    private static final long serialVersionUID = -488767093;
     ...
     */
    public final TableField<AtStateRecord, Long> DB_ID = createField(DSL.name("db_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>DB.at_state.at_id</code>.
     */
    public final TableField<AtStateRecord, Long> AT_ID = createField(DSL.name("at_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.state</code>.
     */
    public final TableField<AtStateRecord, byte[]> STATE = createField(DSL.name("state"), org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.prev_height</code>.
     */
    public final TableField<AtStateRecord, Integer> PREV_HEIGHT = createField(DSL.name("prev_height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.next_height</code>.
     */
    public final TableField<AtStateRecord, Integer> NEXT_HEIGHT = createField(DSL.name("next_height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.sleep_between</code>.
     */
    public final TableField<AtStateRecord, Integer> SLEEP_BETWEEN = createField(DSL.name("sleep_between"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.prev_balance</code>.
     */
    public final TableField<AtStateRecord, Long> PREV_BALANCE = createField(DSL.name("prev_balance"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.freeze_when_same_balance</code>.
     */
    public final TableField<AtStateRecord, Boolean> FREEZE_WHEN_SAME_BALANCE = createField(DSL.name("freeze_when_same_balance"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.min_activate_amount</code>.
     */
    public final TableField<AtStateRecord, Long> MIN_ACTIVATE_AMOUNT = createField(DSL.name("min_activate_amount"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.height</code>.
     */
    public final TableField<AtStateRecord, Integer> HEIGHT = createField(DSL.name("height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>DB.at_state.latest</code>.
     */
    public final TableField<AtStateRecord, Boolean> LATEST = createField(DSL.name("latest"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
