...
public class BrsService extends BrsApiServiceGrpc.BrsApiServiceImplBase {
    ...
    public BrsService(DependencyProvider dp) { // TODO each handler should only take the dp
        ...
        handlerMap.put(BroadcastTransactionHandler.class, new BroadcastTransactionHandler(dp));
        handlerMap.put(BroadcastTransactionBytesHandler.class, new BroadcastTransactionBytesHandler(dp));
        handlerMap.put(CompleteBasicTransactionHandler.class, new CompleteBasicTransactionHandler(dp.timeService, dp.transactionProcessor, dp.blockchain));
        handlerMap.put(GetAccountATsHandler.class, new GetAccountATsHandler(dp.atService, dp.accountService));
        handlerMap.put(GetAccountBlocksHandler.class, new GetAccountBlocksHandler(dp.blockchain, dp.blockService, dp.accountService));
        handlerMap.put(GetAccountCurrentOrdersHandler.class, new GetAccountCurrentOrdersHandler(dp.assetExchange));
        handlerMap.put(GetAccountEscrowTransactionsHandler.class, new GetAccountEscrowTransactionsHandler(dp.escrowService));
        handlerMap.put(GetAccountHandler.class, new GetAccountHandler(dp.accountService));
        handlerMap.put(GetAccountsHandler.class, new GetAccountsHandler(dp.accountService));
        handlerMap.put(GetAccountSubscriptionsHandler.class, new GetAccountSubscriptionsHandler(dp.subscriptionService));
        handlerMap.put(GetAccountTransactionsHandler.class, new GetAccountTransactionsHandler(dp.blockchain, dp.accountService));
        handlerMap.put(GetAliasesHandler.class, new GetAliasesHandler(dp.aliasService));
        handlerMap.put(GetAliasHandler.class, new GetAliasHandler(dp.aliasService));
        handlerMap.put(GetAssetBalancesHandler.class, new GetAssetBalancesHandler(dp.assetExchange));
        handlerMap.put(GetAssetHandler.class, new GetAssetHandler(dp.assetExchange));
        handlerMap.put(GetAssetsByIssuerHandler.class, new GetAssetsByIssuerHandler(dp.assetExchange));
        handlerMap.put(GetAssetsHandler.class, new GetAssetsHandler(dp.assetExchange));
        handlerMap.put(GetAssetTradesHandler.class, new GetAssetTradesHandler(dp.assetExchange));
        handlerMap.put(GetAssetTransfersHandler.class, new GetAssetTransfersHandler(dp.assetExchange, dp.accountService));
        handlerMap.put(GetATHandler.class, new GetATHandler(dp.atService, dp.accountService));
        handlerMap.put(GetATIdsHandler.class, new GetATIdsHandler(dp.atService));
        handlerMap.put(GetBlockHandler.class, new GetBlockHandler(dp.blockchain, dp.blockService));
        handlerMap.put(GetBlocksHandler.class, new GetBlocksHandler(dp.blockchain, dp.blockService));
        handlerMap.put(GetConstantsHandler.class, new GetConstantsHandler(dp.fluxCapacitor));
        handlerMap.put(GetCountsHandler.class, new GetCountsHandler(dp.accountService, dp.escrowService, dp.blockchain, dp.assetExchange, dp.aliasService, dp.generator));
        handlerMap.put(GetCurrentTimeHandler.class, new GetCurrentTimeHandler(dp.timeService));
        handlerMap.put(GetDgsGoodHandler.class, new GetDgsGoodHandler(dp.digitalGoodsStoreService));
        handlerMap.put(GetDgsGoodsHandler.class, new GetDgsGoodsHandler(dp.digitalGoodsStoreService));
        handlerMap.put(GetDgsPendingPurchasesHandler.class, new GetDgsPendingPurchasesHandler(dp.digitalGoodsStoreService));
        handlerMap.put(GetDgsPurchaseHandler.class, new GetDgsPurchaseHandler(dp.digitalGoodsStoreService));
        handlerMap.put(GetDgsPurchasesHandler.class, new GetDgsPurchasesHandler(dp.digitalGoodsStoreService));
        handlerMap.put(GetEscrowTransactionHandler.class, new GetEscrowTransactionHandler(dp.escrowService));
        handlerMap.put(GetMiningInfoHandler.class, new GetMiningInfoHandler(dp.blockchainProcessor, dp.blockchain, dp.generator));
        handlerMap.put(GetOrderHandler.class, new GetOrderHandler(dp.assetExchange));
        handlerMap.put(GetOrdersHandler.class, new GetOrdersHandler(dp.assetExchange));
        handlerMap.put(GetPeersHandler.class, new GetPeersHandler());
        handlerMap.put(GetStateHandler.class, new GetStateHandler(dp.timeService, dp.blockchain, dp.generator, dp.blockchainProcessor, dp.propertyService));
        handlerMap.put(GetSubscriptionHandler.class, new GetSubscriptionHandler(dp.subscriptionService));
        handlerMap.put(GetSubscriptionsToAccountHandler.class, new GetSubscriptionsToAccountHandler(dp.subscriptionService));
        handlerMap.put(GetTransactionBytesHandler.class, new GetTransactionBytesHandler(dp));
        handlerMap.put(GetTransactionHandler.class, new GetTransactionHandler(dp.blockchain, dp.transactionProcessor));
        handlerMap.put(GetUnconfirmedTransactionsHandler.class, new GetUnconfirmedTransactionsHandler(dp.indirectIncomingService, dp.transactionProcessor));
        handlerMap.put(ParseTransactionHandler.class, new ParseTransactionHandler(dp));
        handlerMap.put(SubmitNonceHandler.class, new SubmitNonceHandler(dp.propertyService, dp.blockchain, dp.accountService, dp.generator));
        handlerMap.put(SuggestFeeHandler.class, new SuggestFeeHandler(dp.feeSuggestionCalculator));
