...
public final class ProtoBuilder {
    ...
    public static BrsApi.AT buildAT(AccountService accountService, AT at) {
        ...
        return BrsApi.AT.newBuilder()
                ...
                .setRunning(at.getMachineState().getRunning())
                .setStopped(at.getMachineState().getStopped())
                .setFinished(at.getMachineState().getFinished())
                .setDead(at.getMachineState().getDead())
