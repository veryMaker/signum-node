...
object Parameters {
    ...
    const val AMOUNT_NQT_PARAMETER = "amountNQT"
    const val ALIAS_NAME_PARAMETER = "aliasName"
    const val FEE_NQT_PARAMETER = "feeNQT"
    const val PRICE_NQT_PARAMETER = "priceNQT"
    ...
    const val REFUND_NQT_PARAMETER = "refundNQT"
    ...
    const val MIN_ACTIVATION_AMOUNT_NQT_PARAMETER = "minActivationAmountNQT"
    const val DISCOUNT_NQT_PARAMETER = "discountNQT"
