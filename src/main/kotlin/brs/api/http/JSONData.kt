...
import brs.api.http.common.ResultFields.ALIAS_URI_RESPONSE
import brs.api.http.common.ResultFields.AMOUNT_PLANCK_RESPONSE
import brs.api.http.common.ResultFields.ASK_ORDER_HEIGHT_RESPONSE
import brs.api.http.common.ResultFields.ASK_ORDER_RESPONSE
import brs.api.http.common.ResultFields.ASSET_RESPONSE
import brs.api.http.common.ResultFields.ASSET_TRANSFER_RESPONSE
import brs.api.http.common.ResultFields.ATTACHMENT_RESPONSE
import brs.api.http.common.ResultFields.BALANCE_PLANCK_RESPONSE
import brs.api.http.common.ResultFields.BASE_TARGET_RESPONSE
import brs.api.http.common.ResultFields.BID_ORDER_HEIGHT_RESPONSE
import brs.api.http.common.ResultFields.BID_ORDER_RESPONSE
import brs.api.http.common.ResultFields.BLOCK_RESPONSE
import brs.api.http.common.ResultFields.BLOCK_REWARD_RESPONSE
import brs.api.http.common.ResultFields.BLOCK_SIGNATURE_RESPONSE
import brs.api.http.common.ResultFields.BLOCK_TIMESTAMP_RESPONSE
import brs.api.http.common.ResultFields.BUYER_RESPONSE
import brs.api.http.common.ResultFields.CONFIRMATIONS_RESPONSE
import brs.api.http.common.ResultFields.DATA_RESPONSE
...
import brs.api.http.common.ResultFields.FEEDBACK_NOTES_RESPONSE
import brs.api.http.common.ResultFields.FEE_PLANCK_RESPONSE
...
import brs.api.http.common.ResultFields.GENERATION_SIGNATURE_RESPONSE
import brs.api.http.common.ResultFields.GENERATOR_PUBLIC_KEY_RESPONSE
import brs.api.http.common.ResultFields.GENERATOR_RESPONSE
...
import brs.api.http.common.ResultFields.NEXT_BLOCK_RESPONSE
import brs.api.http.common.ResultFields.NONCE_RESPONSE
import brs.api.http.common.ResultFields.NOTE_RESPONSE
...
import brs.api.http.common.ResultFields.NUMBER_OF_TRANSACTIONS_RESPONSE
...
import brs.api.http.common.ResultFields.PAYLOAD_HASH_RESPONSE
import brs.api.http.common.ResultFields.PAYLOAD_LENGTH_RESPONSE
import brs.api.http.common.ResultFields.PENDING_RESPONSE
import brs.api.http.common.ResultFields.PREVIOUS_BLOCK_HASH_RESPONSE
import brs.api.http.common.ResultFields.PREVIOUS_BLOCK_RESPONSE
import brs.api.http.common.ResultFields.PRICE_PLANCK_RESPONSE
import brs.api.http.common.ResultFields.PUBLIC_FEEDBACKS_RESPONSE
...
import brs.api.http.common.ResultFields.REFERENCED_TRANSACTION_FULL_HASH_RESPONSE
import brs.api.http.common.ResultFields.REFUND_NOTE_RESPONSE
...
import brs.api.http.common.ResultFields.SCOOP_NUM_RESPONSE
import brs.api.http.common.ResultFields.SELLER_RESPONSE
import brs.api.http.common.ResultFields.SENDER_PUBLIC_KEY_RESPONSE
...
import brs.api.http.common.ResultFields.SIGNATURE_RESPONSE
import brs.api.http.common.ResultFields.SIGNERS_RESPONSE
import brs.api.http.common.ResultFields.SUBTYPE_RESPONSE
...
import brs.api.http.common.ResultFields.TOTAL_AMOUNT_PLANCK_RESPONSE
import brs.api.http.common.ResultFields.TOTAL_FEE_PLANCK_RESPONSE
import brs.api.http.common.ResultFields.TRADE_TYPE_RESPONSE
...
import brs.api.http.common.ResultFields.TYPE_RESPONSE
...
object JSONData {
    ...
    internal fun at(at: AT, accountService: AccountService): JsonObject {
        val json = JsonObject()
        putAccount(json, "creator", at.creator)
        json.addProperty("at", at.id.toUnsignedString())
        json.addProperty("atRS", at.id.rsAccount())
        json.addProperty("atVersion", at.version)
        json.addProperty("name", at.name)
        json.addProperty("description", at.description)
        json.addProperty("creator", at.creator.toUnsignedString())
        json.addProperty("creatorRS", at.creator.rsAccount())
        json.addProperty("machineCode", at.apCodeBytes.toHexString())
        json.addProperty("machineData", at.apDataBytes.toHexString())
        json.addProperty("balanceNQT", accountService.getAccount(at.id)!!.balancePlanck.toUnsignedString())
