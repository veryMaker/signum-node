...
object ProtoBuilder {
    ...
    fun buildBlock(blockchainService: BlockchainService, blockService: BlockService, block: Block, includeTransactions: Boolean): BrsApi.Block {
                ...
                try {
                    when {
                        ...
                        appendix.`is`(BrsApi.PublicKeyAnnouncementAppendix::class.java) -> transactionBuilder.publicKeyAnnouncement(
                            Appendix.PublicKeyAnnouncement(dp, appendix.unpack(BrsApi.PublicKeyAnnouncementAppendix::class.java), blockchainHeight))
                    }
