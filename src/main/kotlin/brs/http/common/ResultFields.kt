...
object ResultFields {
    ...
    const val BALANCE_NQT_RESPONSE = "balanceNQT"
    const val BALANCE_QNT_RESPONSE = "balanceQNT"
    const val UNCONFIRMED_BALANCE_NQT_RESPONSE = "unconfirmedBalanceNQT"
    const val UNCONFIRMED_BALANCE_QNT_RESPONSE = "unconfirmedBalanceQNT"
    const val EFFECTIVE_BALANCE_NQT_RESPONSE = "effectiveBalanceNXT"
    const val FORGED_BALANCE_NQT_RESPONSE = "forgedBalanceNQT"
    const val GUARANTEED_BALANCE_NQT_RESPONSE = "guaranteedBalanceNQT"
    ...
    const val TOTAL_AMOUNT_NQT_RESPONSE = "totalAmountNQT"
    const val TOTAL_FEE_NQT_RESPONSE = "totalFeeNQT"
    ...
    const val UNCONFIRMED_QUANTITY_QNT_RESPONSE = "unconfirmedQuantityQNT"
    const val PRICE_NQT_RESPONSE = "priceNQT"
    ...
    const val DISCOUNT_NQT_RESPONSE = "discountNQT"
    const val REFUND_NQT_RESPONSE = "refundNQT"
    ...
    const val AMOUNT_NQT_RESPONSE = "amountNQT"
    const val FEE_NQT_RESPONSE = "feeNQT"
