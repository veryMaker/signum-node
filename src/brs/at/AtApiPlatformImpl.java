...
public class AtApiPlatformImpl extends AtApiImpl {
    ...
    public long getRandomIdForTxInA(AtMachineState state) {
        ...
        ByteBuffer bf = ByteBuffer.allocate((Burst.getFluxCapacitor().getValue(FluxValues.SODIUM)) ? 32 + Long.SIZE + senderPublicKey.length : 32 + Long.SIZE + senderPublicKey.length);
