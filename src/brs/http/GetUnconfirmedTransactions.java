...
public final class GetUnconfirmedTransactions extends APIServlet.APIRequestHandler {
  ...
  JSONStreamAware processRequest(HttpServletRequest req) {
    ...
    final Long limitUnconfirmedTransactionsRetrieved = limitUnconfirmedTransactionsRetrievedParameter != null ? Convert.parseLong(limitUnconfirmedTransactionsRetrievedParameter) : Integer.MAX_VALUE;
