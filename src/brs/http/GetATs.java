...
public final class GetATs extends APIServlet.JsonRequestHandler {
  ...
  GetATs(ATService atService) {
    super(new APITag[] {APITag.AT, APITag.ACCOUNTS}, MACHINE_CODE_HASH_ID_PARAMETER, INCLUDE_DETAILS_PARAMETER, FIRST_INDEX_PARAMETER, LAST_INDEX_PARAMETER);
