...
public class Indexes {
    ...
    public static final Index ACCOUNT_ASSET_ACCOUNT_ASSET_HEIGHT_IDX = Internal.createIndex(DSL.name("account_asset_height_idx"), AccountAsset.ACCOUNT_ASSET, new OrderField[] { AccountAsset.ACCOUNT_ASSET.HEIGHT }, false);
    ...
    public static final Index ACCOUNT_BALANCE_ACCOUNT_BALANCE_HEIGHT_IDX = Internal.createIndex(DSL.name("account_balance_height_idx"), AccountBalance.ACCOUNT_BALANCE, new OrderField[] { AccountBalance.ACCOUNT_BALANCE.HEIGHT }, false);
    public static final Index ACCOUNT_BALANCE_ACCOUNT_BALANCE_ID_LATEST_IDX = Internal.createIndex(DSL.name("account_balance_id_latest_idx"), AccountBalance.ACCOUNT_BALANCE, new OrderField[] { AccountBalance.ACCOUNT_BALANCE.ID, AccountBalance.ACCOUNT_BALANCE.LATEST }, false);
    public static final Index ACCOUNT_ACCOUNT_HEIGHT_IDX = Internal.createIndex(DSL.name("account_height_idx"), Account.ACCOUNT, new OrderField[] { Account.ACCOUNT.HEIGHT }, false);
    ...
    public static final Index ALIAS_ALIAS_HEIGHT_IDX = Internal.createIndex(DSL.name("alias_height_idx"), Alias.ALIAS, new OrderField[] { Alias.ALIAS.HEIGHT }, false);
    ...
    public static final Index ALIAS_OFFER_ALIAS_OFFER_HEIGHT_IDX = Internal.createIndex(DSL.name("alias_offer_height_idx"), AliasOffer.ALIAS_OFFER, new OrderField[] { AliasOffer.ALIAS_OFFER.HEIGHT }, false);
    ...
    public static final Index ASK_ORDER_ASK_ORDER_HEIGHT_IDX = Internal.createIndex(DSL.name("ask_order_height_idx"), AskOrder.ASK_ORDER, new OrderField[] { AskOrder.ASK_ORDER.HEIGHT }, false);
    ...
    public static final Index ASSET_ASSET_HEIGHT_IDX = Internal.createIndex(DSL.name("asset_height_idx"), Asset.ASSET, new OrderField[] { Asset.ASSET.HEIGHT }, false);
    ...
    public static final Index ASSET_TRANSFER_ASSET_TRANSFER_HEIGHT_IDX = Internal.createIndex(DSL.name("asset_transfer_height_idx"), AssetTransfer.ASSET_TRANSFER, new OrderField[] { AssetTransfer.ASSET_TRANSFER.HEIGHT }, false);
    ...
    public static final Index AT_AT_HEIGHT_IDX = Internal.createIndex(DSL.name("at_height_idx"), At.AT, new OrderField[] { At.AT.HEIGHT }, false);
    public static final Index AT_MAP_AT_MAP_HEIGHT_IDX = Internal.createIndex(DSL.name("at_map_height_idx"), AtMap.AT_MAP, new OrderField[] { AtMap.AT_MAP.HEIGHT }, false);
    public static final Index AT_STATE_AT_STATE_HEIGHT_IDX = Internal.createIndex(DSL.name("at_state_height_idx"), AtState.AT_STATE, new OrderField[] { AtState.AT_STATE.HEIGHT }, false);
    ...
    public static final Index BID_ORDER_BID_ORDER_HEIGHT_IDX = Internal.createIndex(DSL.name("bid_order_height_idx"), BidOrder.BID_ORDER, new OrderField[] { BidOrder.BID_ORDER.HEIGHT }, false);
    ...
    public static final Index INDIRECT_INCOMING_INDIRECT_INCOMING_HEIGHT_IDX = Internal.createIndex(DSL.name("indirect_incoming_height_idx"), IndirectIncoming.INDIRECT_INCOMING, new OrderField[] { IndirectIncoming.INDIRECT_INCOMING.HEIGHT }, false);
    ...
    public static final Index REWARD_RECIP_ASSIGN_REWARD_RECIP_ASSIGN_HEIGHT_IDX = Internal.createIndex(DSL.name("reward_recip_assign_height_idx"), RewardRecipAssign.REWARD_RECIP_ASSIGN, new OrderField[] { RewardRecipAssign.REWARD_RECIP_ASSIGN.HEIGHT }, false);
    ...
    public static final Index SUBSCRIPTION_SUBSCRIPTION_HEIGHT_IDX = Internal.createIndex(DSL.name("subscription_height_idx"), Subscription.SUBSCRIPTION, new OrderField[] { Subscription.SUBSCRIPTION.HEIGHT }, false);
    ...
    public static final Index TRADE_TRADE_HEIGHT_IDX = Internal.createIndex(DSL.name("trade_height_idx"), Trade.TRADE, new OrderField[] { Trade.TRADE.HEIGHT }, false);
    ...
    public static final Index TRANSACTION_TRANSACTION_TYPE_SUBTYPE_IDX = Internal.createIndex(DSL.name("transaction_type_subtype_idx"), Transaction.TRANSACTION, new OrderField[] { Transaction.TRANSACTION.TYPE, Transaction.TRANSACTION.SUBTYPE }, false);
