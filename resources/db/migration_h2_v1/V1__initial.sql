...
(
  ...
  generator_account_id  BIGINT     NOT NULL,
...
ALTER TABLE block
  ALTER COLUMN generator_account_id RENAME TO generator_id;
ALTER TABLE transaction
  ALTER COLUMN sender_account_id RENAME TO sender_id;
...
ALTER TABLE transaction
  DROP COLUMN IF EXISTS index;
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS block_timestamp INT;
ALTER TABLE transaction
  ALTER COLUMN block_timestamp SET NOT NULL;
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS hash BINARY(32);
CREATE INDEX IF NOT EXISTS transaction_hash_idx ON transaction (hash);
ALTER TABLE block
  ALTER COLUMN total_amount BIGINT;
ALTER TABLE block
  ALTER COLUMN total_fee BIGINT;
ALTER TABLE transaction
  ALTER COLUMN amount BIGINT;
ALTER TABLE transaction
  ALTER COLUMN fee BIGINT;
CREATE TABLE IF NOT EXISTS peer
(
  address VARCHAR PRIMARY KEY
);
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS full_hash BINARY(32);
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS referenced_transaction_full_hash BINARY(32);
ALTER TABLE transaction
  ALTER COLUMN full_hash SET NOT NULL;
CREATE UNIQUE INDEX IF NOT EXISTS transaction_full_hash_idx ON transaction (full_hash);
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS attachment_bytes VARBINARY;
ALTER TABLE transaction
  DROP COLUMN attachment;
ALTER TABLE transaction
  DROP COLUMN referenced_transaction_id;
ALTER TABLE transaction
  DROP COLUMN hash;
DROP INDEX transaction_recipient_id_idx;
ALTER TABLE transaction
  ALTER COLUMN recipient_id SET NULL;
CREATE INDEX IF NOT EXISTS transaction_recipient_id_idx ON transaction (recipient_id);
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS version TINYINT;
UPDATE transaction
SET version = 0;
ALTER TABLE transaction
...
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS has_encrypted_message BOOLEAN NOT NULL DEFAULT FALSE;
UPDATE transaction
SET has_message = TRUE
WHERE type = 1
  AND subtype = 0;
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS has_public_key_announcement BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS ec_block_height INT DEFAULT NULL;
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS ec_block_id BIGINT DEFAULT NULL;
ALTER TABLE transaction
  ADD COLUMN IF NOT EXISTS has_encrypttoself_message BOOLEAN NOT NULL DEFAULT FALSE;
...
ALTER TABLE transaction
  ALTER COLUMN signature SET NULL;
...
ALTER TABLE block
  ADD COLUMN IF NOT EXISTS ats BINARY;
...
ALTER TABLE account
  DROP COLUMN IF EXISTS current_leasing_height_from;
ALTER TABLE account
  DROP COLUMN IF EXISTS current_leasing_height_to;
ALTER TABLE account
  DROP COLUMN IF EXISTS current_lessee_id;
ALTER TABLE account
  DROP COLUMN IF EXISTS next_leasing_height_from;
ALTER TABLE account
  DROP COLUMN IF EXISTS next_leasing_height_to;
ALTER TABLE account
  DROP COLUMN IF EXISTS next_lessee_id;
ALTER TABLE transaction
  ALTER COLUMN referenced_transaction_full_hash RENAME TO referenced_transaction_fullhash;
ALTER TABLE alias
  ALTER COLUMN alias_name_LOWER RENAME TO alias_name_lower;
CREATE INDEX IF NOT EXISTS account_id_latest_idx ON account (id, latest);
ALTER TABLE alias
  ALTER COLUMN alias_name_lower VARCHAR NOT NULL;
